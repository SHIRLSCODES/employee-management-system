<x-admin-layout>
    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            <div class="grow">
                <h5 class="text-16">Admin - Attendance Management</h5>
            </div>
            <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                <li class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                    <a href="#!" class="text-slate-400 dark:text-zink-200">Admin Dashboard / Attendance Records</a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-span-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-4 text-15">All Employee Attendance Records</h6>
                                    ...
                                    <tr class="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                       <td class="px-4 py-2">
                                            ...
                                            <span class="text-xs text-gray-500 block">
                                                ID: {{ $attendance->attendable->id ?? 'N/A' }}
                                            </span>
                                        </td>
