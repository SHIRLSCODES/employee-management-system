<x-admin-layout>
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            <div class="grow">
                <h5 class="text-16">Admin Check-Out</h5>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-4 text-gray-800 text-16 dark:text-zink-50">Daily Check-Out</h6>
                ...
                <form action="{{ route('admin.attendance.edit') }}" method="POST">
                    @csrf
