<x-admin-layout>
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.stockRequisitions.update', $stockRequisition->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="flex justify-end gap-2 mt-5">
                        ...
                        <a href="{{ route('admin.stockRequisitions.index') }}" class="text-white btn bg-slate-500 border-slate-500 hover:bg-slate-600 hover:border-slate-600">
                            Back to List
                        </a>
