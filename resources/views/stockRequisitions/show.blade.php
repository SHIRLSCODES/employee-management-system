            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                    ...
                    <div class="xl:col-span-4">
                        ...
                        <span class="px-2 py-1 rounded-full text-sm font-semibold border
                            @if($stockRequisition->status === 'approved') bg-green-600 text-black border-green-500
                            @elseif($stockRequisition->status === 'pending') bg-yellow-600 text-black border-yellow-500
                            @elseif($stockRequisition->status === 'denied') bg-red-600 text-black border-red-500
                            @else bg-gray-600 text-black border-gray-400
                            @endif">
                ...
                <div class="flex justify-end gap-2 mt-5">
                    ...
                    @if($stockRequisition->status === 'pending')
                        <a href="{{ route('stockRequisitions.edit', $stockRequisition->id) }}" class="text-blue btn bg-blue-600 border-blue-600 hover:bg-blue-500 hover:border-blue-500">
                            Edit Requisition
                        </a>
                    @endif
                </div>
