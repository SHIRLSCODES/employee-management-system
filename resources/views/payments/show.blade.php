                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-6 flex gap-3">
                            <a href="{{ route('payments.index') }}" class="btn border border-gray-300 dark:border-zink-400 text-gray-700 dark:text-zink-200 hover:bg-gray-100 dark:hover:bg-zink-700">
                                Back to List
                            </a>

                            @if ($paymentRequest->status === 'pending')
                                <a href="{{ route('payments.edit', $paymentRequest->id) }}" class="btn text-white bg-green-500 hover:bg-green-600">
                                    Edit Request
                                </a>
                                <form method="POST" action="{{ route('payments.destroy', $paymentRequest->id) }}" onsubmit="return confirm('Are you sure you want to delete this request?');">
                                    @csrf
                                    @method('DELETE')
