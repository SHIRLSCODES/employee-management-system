        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('payments.store') }}" method="POST">
                    @csrf
                    <h6 class="mb-4 text-gray-800 text-16 dark:text-zink-50">Request for Payment</h6>
                ...
                <script>
                    ...
                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-4">
                            ...
                            <x-text-input type="text" id="description" name="description" value="{{ old('description') }}" placeholder="What, why, and when" required />
                            <x-input-error :messages="$errors->get('description')" class="mt-2" />
                        </div>

                        <div class="xl:col-span-4">
                            <label for="amount" class="inline-block mb-2 text-base font-medium">Amount (₦):</label>
                            <x-text-input type="number" id="amount" name="amount" value="{{ old('amount') }}" required />
